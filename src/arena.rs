...
mod tests 
{
   ...
   #[test]
    ...
    fn arena_alloc_check_index() 
    {
        ...
        let last0 = Index{arena : arena.id(), age : 0, index : ARENA_CHUNK_SIZE - 1};
        let after_last0 = Index{arena : arena.id(), age : 0, index : ARENA_CHUNK_SIZE};
